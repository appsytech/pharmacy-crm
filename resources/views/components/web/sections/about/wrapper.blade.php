...
<div class="overflow-hidden space" id="about-sec">
    <div class="shape-mockup" data-top="0" data-right="0">
        <img src="{{ asset('assets/img/shape/pattern_shape_1.png') }}" alt="shape">
    </div>
    <div class="shape-mockup jump" data-bottom="10%" data-right="3%">
        <img src="{{ asset('assets/img/shape/medicine_1.png') }}" alt="shape">
    </div>
    <div class="container">
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 mb-30 mb-xl-0">
                <div class="img-box1">
                    <div class="img1">
                        <img src="{{ asset('assets/img/normal/about_1_3.png') }}" alt="About">
                    </div>
            ...
            <div class="col-xl-6">
                <div class="ps-xxl-4 ms-xl-2 text-center text-xl-start">
                    ...
                    <div>
                        <a href="{{ route('web.about.index') }}" class="th-btn">More About Us</a>
                    </div>
                    <div class="about-video-wrap">
                        <div class="th-video about-video">
                            <img src="{{ asset('assets/img/normal/about_1_4.jpg') }}" alt="video">
                            <a href="https://www.youtube.com/watch?v=_sI_Ps7JSEk" class="play-btn popup-video">
                                <i class="fas fa-play"></i></a>
                        </div>
                        <div class="box-content">
                            <p class="box-text">
                                We offer flexible appointment scheduling options to accommodate your
                            ...
                            <div class="about-contact-wrap">
                                ...
                                <div class="about-contact">
                                    ...
                                    <h3 class="box-title">
                                        ...
                                        <a href="{{ route('web.contact.index') }}">Book Here</a>
                                    </h3>
                                </div>
                            </div>
                        </div>
