        ...
        <div class="swiper-wrapper">
                    ...
                    <div class="container">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinup" data-ani-delay="0.2s">
                                Trusted Care for Indian Families</span>
                            <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.3s">
                                Advanced Clinical Care</h1>
                            <h2 class="hero-heading" data-ani="slideinup" data-ani-delay="0.4s">
                                Consult <span class="text-theme">Experienced Doctors</span> Today</h2>
                            <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">
                                Our clinic provides ethical, affordable and evidence-based medical treatment
                                with a focus on patient safety, hygiene and personalized care for all age groups.</p>
                            <a href="appointment.html" class="th-btn style2" data-ani="slideinup" data-ani-delay="0.6s" id="showAppointmentBtn">
                                <i class="fas fa-user-md me-2"></i>Book Appointment
                            </a>
                        </div>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="container">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinup" data-ani-delay="0.2s"> Medical-Grade Protection You Can Trust</span>
                            <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.3s">Surgical Hand Gloves</h1>
                            <h2 class="hero-heading" data-ani="slideinup" data-ani-delay="0.4s">Ensuring <span class="text-theme">Safety & Hygiene</span> in Every Procedure</span></h2>
                            <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">High-quality disposable surgical gloves designed for Indian clinics and hospitals, offering superior comfort, strong grip and reliable protection during examinations and surgical procedures.</p>
                            <a href="appointment.html" class="th-btn style2" data-ani="slideinup" data-ani-delay="0.6s" id="showAppointmentBtn">
                                <i class="fas fa-user-md me-2"></i>Book Appointment
                            </a>
                        </div>
            ...
            <div class="swiper-slide">
                <div class="hero-inner">
                    <div class="container">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinup" data-ani-delay="0.2s">
                                Accurate & Reliable Health Monitoring
                            </span>
                            <h1 class="hero-title" data-ani="slideinup" data-ani-delay="0.3s">
                                Blood Pressure Monitor
                            </h1>
                            <h2 class="hero-heading" data-ani="slideinup" data-ani-delay="0.4s">
                                Track Your <span class="text-theme">Heart Health</span> Daily
                            </h2>
                            <p class="hero-text" data-ani="slideinup" data-ani-delay="0.5s">
                                Clinically tested blood pressure meter designed for Indian clinics and home use,
                                providing precise readings to help manage hypertension and overall cardiovascular health.
                            </p>
                            <a href="appointment.html" class="th-btn style2" data-ani="slideinup" data-ani-delay="0.6s" id="showAppointmentBtn">
                                <i class="fas fa-user-md me-2"></i>Book Appointment
                            </a>
            ...
            <div class="col-xl-6 mb-30 mb-xl-0">
                <div class="img-box1">
                    ...
                    <div class="about-info">
                        <h3 class="box-title">Dr. Abhishek Singh</h3>
                        <p class="box-text">Mention the languages <br> in which the staff.</p>
                        <div class="box-review">
                            <i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i><i class="fa-sharp fa-solid fa-star"></i>
                        </div>
                        <a href="tel:+918340138097" class="box-link"><i class="fa-solid fa-phone"></i> +91 8340138097</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8">
                <div class="title-area text-center">
                    ...
                    <h2 class="sec-title">Our Tata Medical D S Pvt specialties Technical service</h2>
                </div>
            </div>
        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="blog-card">
                            ...
                            <div class="blog-content">
                                <div class="blog-meta">
                                    <a href="blog.html"><i class="fal fa-user"></i>By Tata Medical</a>
