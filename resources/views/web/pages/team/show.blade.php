        ...
        <div class="row gy-40">
            <div class="col-xl-4 position-relative">
                <div class="team-sticky">
                    <div class="about-box mb-40">
                        <div class="box-img">
                            <img src="assets/img/team/team_details.jpg" alt="team image">
                        </div>
                        <div class="box-content">
                            <h3 class="box-title">Dr. Douglas Lyphe</h3>
                            <p class="box-desig">Physiotherapist</p>
                            <p class="box-text">Our team of skilled doctors, nurses, and specialists bring years of experience and expertise to ensure you receive.</p>
                        </div>
                    </div>
                    <div class="about-box">
                        <div class="box-content">
                            ...
                            <p class="box-link">
                                ...
                                <a href="mailto:abhisingh090299@gmail.com">abhisingh090299@gmail.com</a>
                            </p>
                            <p class="box-link">
                                <i class="icon-btn fas fa-location-dot"></i>
                                2478 Street City Patna 801503
                            </p>
                            <p class="box-link">
            ...
            <div class="col-xl-8">
                <div class="team-details">
                    ...
                    <form action="mail.php" method="POST" class="team-contact-form mt-5">
