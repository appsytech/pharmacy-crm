                    ...
                    (n = {
                        ...
                        B: function () {
                            var e = 3600 * a.getUTCHours(),
                                ...
                                r = a.getUTCSeconds();
                            return t(
                                Math.floor((e + n + r + 3600) / 86.4) % 1e3,
                                3,
                            );
                        },
                        g: function () {
    ...
    var t = {
        ...
        i = function () {
            ...
            "function" == typeof DateFormatter &&
                (a = n =
                    new DateFormatter({ dateSettings: e.extend({}, o, s) }));
        },
        s = {
            moment: {
                default_options: {
                ...
                (i = function (t) {
                            ...
                            (r(n.mask, t.val()) ||
                                ...
                                t.on("keydown.xdsoft", function (a) {
                                    ...
                                    if (
                                        ...
                                        (-1 !== [v, b, k, x, T].indexOf(d) &&
                                            S) ||
                                        -1 !==
                                        [c, h, p, m, g, y, u, D, f].indexOf(
                                            d,
                                        )
                                    )
                                        return !0;
                    ...
                    (C.find(".xdsoft_select")
                        ...
                        (W.setOptions = function (n) {
                            ...
                            ((M = e.extend(!0, {}, M, n)),
                                ...
                                isNaN(M.dayOfWeekStart)
                                    ? (M.dayOfWeekStart = 0)
                                    : (M.dayOfWeekStart =
                                        parseInt(M.dayOfWeekStart, 10) % 7),
                                M.timepickerScrollbar ||
                                A.xdsoftScroller(M, "hide"),
                                M.minDate &&
                                /^[\+\-](.*)$/.test(M.minDate) &&
                                ...
                                (M.dayOfWeekStartPrev =
                                    0 === M.dayOfWeekStart
                                        ? 6
                                        : M.dayOfWeekStart - 1),
                                W.trigger("xchange.xdsoft").trigger(
                                    "afterOpen.xdsoft",
                                ));
                        }),
                        W.data("options", M).on(
                        ...
                        (w = new (function () {
                            ...
                            ((t.now = function (e) {
                                ...
                                (t.getWeekOfYear = function (t) {
                                    if (
                                        M.onGetWeekOfYear &&
                                        e.isFunction(M.onGetWeekOfYear)
                                    ) {
                                ...
                                (t.strToDate = function (e) {
                                    if (
                                        ...
                                        return e;
                                    var n = e
                                        ? a.parseDate(e, M.formatDate)
                                        : t.now(!0);
                                    return (
                                        t.isValidDate(n) || (n = t.now(!0)),
                                        n
                                    );
                                }),
                        ...
                        Y.find(".xdsoft_prev,.xdsoft_next").on(
                            ...
                            function () {
                                ...
                                (!(function e(o) {
                                    ...
                                    (t.hasClass(M.next) &&
                                        s - i - M.timeHeightInTimePicker >= d
                                        ? H.css(
                                            "marginTop",
                                            "-" +
                                            (d +
                            ...
                            (clearTimeout(o),
                                (o = setTimeout(function () {
                                    ...
                                    for (
                                        ...
                                        g +=
                                            "<th>" +
                                            M.i18n[r].dayOfWeekShort[
                                            (o + M.dayOfWeekStart) % 7
                                            ] +
                                            "</th>";
                                    for (
                                        g += "</tr></thead>",
                                    ...
                                    if (
                                        ...
                                        for (
                                            D = 0;
                                            D < M.allowTimes.length;
                                            D += 1
                                        )
                                            c(
                                                w
                                                    .strtotime(M.allowTimes[D])
                                                    .getHours(),
                                                (j = w
                                                    .strtotime(M.allowTimes[D])
                                                    .getMinutes()),
                        ...
                        W.on("changedatetime.xdsoft", function (t) {
                            if (
                                M.onChangeDateTime &&
                                e.isFunction(M.onChangeDateTime)
                            ) {
                                var a = W.data("input");
                                (M.onChangeDateTime.call(
                                    W,
                                    w.currentTime,
                                    a,
                                    t,
                        ...
                        (d = function () {
                            ...
                            if (
                                ((t = (d = W.data("input")).offset()),
                                    ...
                                    M.ownerDocument.documentElement.clientWidth -
                                    t.left <
                                    F.parent().outerWidth(!0))
                            ) {
                                var h =
                                    F.parent().outerWidth(!0) - a.offsetWidth;
                                r -= h;
                            }
